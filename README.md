...
If you have a userbase, you can use a centralized database for your content and the Etavern as client. You only need to set some environment variables in the .env and build this project
